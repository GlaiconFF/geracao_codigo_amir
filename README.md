...
- Insere automaticamente a numeração em cada página
- Gera um novo PDF com todas as páginas numeradas em sequência
- Salva o último número usado para continuar depois
